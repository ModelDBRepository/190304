...
sp = collections.OrderedDict([
    ...
    ('Propranolol+4xHFS(80s)',['/home/asia/NeuroRD/new_model_half_spine_neck_four_times_longer_diff_PDE4/Model_one_short_dendrite_PKAc_times_3_switching_L_pump_neurogranin_1.5_4_trains_spaced_propranolol_new_seed_300_runtime_900000-all_species-conc.txt_concentrations_','Propranolol+4xHFS', 'gray']),
...
max_val = [spine_max_p,
           dend_max_p]
spine_max_a = {'CaMKII':9.18969501767,
            'PKAc':26.875523889325,
            'Epac':41.156462585,
            'Gibg':5.11,
               'Phos':2.3438951456662505}
